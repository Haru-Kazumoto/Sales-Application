...
class StagnationProducts implements FromCollection, WithHeadings, WithMapping, WithTitle, WithColumnWidths
{
    ...
    */
    public function collection()
    {
        $query = Products::query()
            ...
            ->whereDate('product_journal.stagnation_limit_date', now());
        return $query->get();
    }
