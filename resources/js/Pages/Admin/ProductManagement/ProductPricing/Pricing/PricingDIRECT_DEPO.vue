<template>
    <div class="d-flex flex-column gap-3">
        <div class="d-flex flex-column gap-1">
            <TitlePage title="Penghargaan Produk DIRECT DEPO" subTitle="Pembuatan harga produk untuk delivery DO" />
...
export default defineComponent({
    ...
    setup(props) {
        ...
        function handleSubmitPricing() {
            form.post(route('admin.pricing.direct-depo.post', props.subShipping?.id), {
                onSuccess: (page) => {
                    Swal.fire({
                        icon: "success",
