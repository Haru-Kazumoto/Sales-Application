<template>
    <div class="d-flex flex-column gap-3">
        <div class="d-flex flex-column gap-1">
            <TitlePage title="Penghargaan Produk DIRECT DEPO"
                subTitle="Pembuatan harga produk untuk delivery DIRECT DEPO" />
...
export default defineComponent({
    ...
    setup(props) {
        ...
        function handleSubmitPricing() {
            form.put(route('admin.pricing.direct-depo.update', props.data?.id), {
                onSuccess: (page) => {
                    Swal.fire({
                        icon: "success",
