<template>
    ...
    <div class="d-flex flex-column gap-3 pb-3">
        <TitlePage title="Pengiriman DIRECT DEPO" subTitle="Daftar sub delivery dari delivery DIRECT DEPO" />
        ...
        <n-drawer v-model:show="active" :width="502" placement="right">
            <n-drawer-content title="Buat Sub Delivery (DIRECT DEPO)">
                <div class="d-flex flex-column gap-2">
                    <div class="d-flex flex-column gap-1">
                        <label for="">Nama Sub Delivery (Kota) </label>
                    ...
                    render(row) {
                        return h(
                            NButton,
                            {
                                ...
                                type: "info",
                                onClick() {
                                    router.visit(route('admin.pricing.direct-depo.index.products', row.id));
                                }
                            },
                            {
                                default: () => "Proses"
