<template>
    ...
    <div class="d-flex flex-column gap-3 pb-3">
        <TitlePage title="Pengiriman DIRECT" subTitle="Daftar sub delivery dari delivery DIRECT" />
        ...
        <n-drawer v-model:show="active" :width="502" placement="right">
            <n-drawer-content title="Buat Sub Delivery (DIRECT)">
                <div class="d-flex flex-column gap-2">
                    ...
                    render(row) {
                        return h(
                            NButton,
                            {
                                ...
                                type: "info",
                                onClick() {
                                    router.visit(route('admin.pricing.direct.index.products', row.id));
                                }
                            },
                            {
                                default: () => "Proses"
