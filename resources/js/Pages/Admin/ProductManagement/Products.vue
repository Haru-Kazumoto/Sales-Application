<template>
    <div class="d-flex flex-column gap-4">
        ...
        <div class="d-flex">
            <n-button type="primary" size="large" class="ms-auto" @click="router.visit(route('admin.products.create'))">Tambah Produk</n-button>
        </div>
        <div class="row g-3">
            ...
            <div class="col-12 col-lg-6 d-flex">
                <div class="ms-auto d-flex align-items-lg-center gap-2 justify-content-lg-end w-100">
                    ...
                    <n-input class="w-50" placeholder="" @keyup.enter="handleSearchQuery" v-model:value="filterQuery" />
                </div>
            </div>
        </div>
