...
<html lang="en">
  ...
  <body>
    ...
    <table class="header-table border-bottom">
      <tr>
        ...
        <td width="50%" class="address">
          ...
          Gd. King's Plaza Blok C10<br />
          RT. 003 RW. 011 Kp.Jaung Jaha<br />
          Kel. Jatimekar Kec. Jatiasih<br />
          Bekasi - Jawa Barat<br />
          Telp.: 021-29613236 / 29613237<br />
          Fax: 021-29613235
        </td>
      </tr>
    </table>
      ...
      <tr>
        <td width="55%">
          <div class="customer-box">
            Kepada YTH:<br />
            Khasanah Sari, CV<br /><br />
            KP.Cibarengkok Rt.003 Rw.003 Jatiwangi Cikarang Barat - Bekasi,<br />
            Kab.Bekasi<br /><br />
            NPWP: 02.511.062.9-413.000
          </div>
        </td>
    ...
    <div>Salesman: Dedi Dermawan</div>
    <br />
    ...
    <table class="items-table">
      ...
      <tr>
        <td>1</td>
        <td>10-0045-Terigu Nagamochi Emas</td>
        <td>160</td>
        <td>Bag</td>
        <td style="text-align: right">286,937</td>
        <td style="text-align: right">45,909,910</td>
      </tr>
    </table>
    ...
    <table style="margin-top: 20px">
      <tr>
        <td width="60%">
          ...
          BANK CENTRAL ASIA CAB JATIAS H A/C NO. 675.5010.255
        </td>
        <td width="40%" style="text-align: right">
          <table>
            ...
            <tr>
              <td>Ppn 11%</td>
              <td>: Rp</td>
              <td style="text-align: right">5,050,090</td>
            </tr>
            <tr>
              <td>Total</td>
              <td>: Rp</td>
              <td style="text-align: right">50,960,000</td>
            </tr>
          </table>
        </td>
      </tr>
    ...
    <table style="margin-top: 30px">
      <tr>
        <td width="40%" style="text-align: left">
          ...
          <span style="font-weight: bold">Dedi Dermawan</span><br />
          <span style="font-style: italic">Directur</span>
        </td>
      </tr>
    </table>
